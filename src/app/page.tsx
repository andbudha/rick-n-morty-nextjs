  ...
  return (
    <main className={styles.home_main_box}>
      ...
      <p>
        ...
        <span className={styles.home_page_span}>Next.js</span> and I really hope
        this page gets{' '}
      ...
      <p>
        ...
        <span className={styles.home_page_span}>'as client'</span>. I will have
        to ask our mentor <span className={styles.home_page_span}>Raul</span>,
        during the prsenetation of this{' '}
        <span className={styles.home_page_span}>itsy-bitsy</span> project, that
        if we specify that a page should be used{' '}
